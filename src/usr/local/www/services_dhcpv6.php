...
if (isset($_POST['apply'])) {
	...
	if (!$input_errors) {
		...
		$config['dhcpdv6'][$if]['disable-dhcp6c-dns'] = $_POST['disable-dhcp6c-dns'];
...
))->setHelp('Checking this box will disable the dhcp6.name-servers option in /var/dhcpd/etc/dhcpdv6.conf ' .
			'Use with caution, as this behavior may violate RFCs.');
